...
r.style.setProperty('--scroll-bar-width', (window.innerWidth - document.documentElement.clientWidth) + 'px');
...
const miniCartAjaxUpdate = () => {
    ...
    $('body').on('click', function(e){
        if (!( e.target.closest('.ic-cart-sidebar-wrapper') || e.target.closest('.ic-cart-header-btn') )) {
            $('body').removeClass('active-mini-cart');
        }
    });
