			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_widget_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
				...
				<li data-ic_product_id="<?php echo esc_attr($product_id); ?>" data-key="<?php echo $cart_item_key; ?>" class="test woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<div class="ic-mini-cart-count-price ic-mini-cart-title-input">
						...
						<div class="mini_cart_articles">
							<span>Artikel </span>
							<span><?php echo esc_html( $_product->get_sku() ); ?></span>
						</div>

						<div class="mini_cart_price_wrapper">

							<div class="mini_cart_quantity_wrapper">

								<button type="button" class="ic-item-quantity-btn minus" data-type="minus">-</button>
								...
								<button type="button" class="ic-item-quantity-btn plus" data-type="plus"> +</button>
							...
							<div class="ic-custom-render-total">
								<?php echo $cart_item['line_total'] . ' ' . get_woocommerce_currency_symbol(); ?>
							</div>
